...
public class AdminSignUp extends JFrame {
	...
	public AdminSignUp() {
		...
		lblNewLabel_6.setIcon(new ImageIcon("C:\\Users\\User\\Desktop\\StudentFeedback\\src\\img\\back.png"));
		lblNewLabel_6.setBackground(new Color(240, 240, 240));
		lblNewLabel_6.setBounds(8, 10, 42, 35);
		contentPane.add(lblNewLabel_6);

		lblNewLabel_3 = new JLabel("");
		lblNewLabel_3.setIcon(new ImageIcon("C:\\Users\\User\\Desktop\\StudentFeedback\\src\\img\\padlock.png"));
		lblNewLabel_3.setBounds(94, 48, 128, 144);
		contentPane.add(lblNewLabel_3);

		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\User\\Desktop\\StudentFeedback\\src\\img\\background.jpeg"));
