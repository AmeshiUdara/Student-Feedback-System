...
/**
 * This GUI retrieves the lecturer list and question list from the server and shows them to the user. 
 * The user needs to choose one particular lecturer and provide answers. 
 * The user can't skip any question. Provided answers keep in memory as a list until the user submit. 
 * After the submission application will update the answer counts in the database through the server.<br><br>
 * 
 * 
...
public class QuestionnaireView extends JFrame {
	...
	public QuestionnaireView() throws Exception {
		...
		extremeImg.setBounds(10, 0, 76, 86);
		extremeImg.setIcon(new ImageIcon("C:\\Users\\User\\Desktop\\StudentFeedback\\src\\img\\SmilingY.png"));
		panel.add(extremeImg);
		JLabel agreeImg = new JLabel("");
		agreeImg.setIcon(new ImageIcon("C:\\Users\\User\\Desktop\\StudentFeedback\\src\\img\\SmileY.png"));
		agreeImg.setBounds(178, 5, 78, 75);
		panel.add(agreeImg);

		JLabel maybeImg = new JLabel("");
		maybeImg.setIcon(new ImageIcon("C:\\Users\\User\\Desktop\\StudentFeedback\\src\\img\\NeutralY.png"));
		maybeImg.setBounds(350, 5, 79, 72);
		panel.add(maybeImg);

		JLabel noImg = new JLabel("");
		noImg.setIcon(new ImageIcon("C:\\Users\\User\\Desktop\\StudentFeedback\\src\\img\\DisagreeY.png"));
		noImg.setBounds(517, 5, 82, 75);
		panel.add(noImg);

		JLabel lblNewLabel_4 = new JLabel(currentQuestion.getAnswer1());
		lblNewLabel_4.setFont(new Font("Corbel", Font.BOLD, 15));
		lblNewLabel_4.setBounds(10, 88, 78, 20);
		panel.add(lblNewLabel_4);

		JLabel lblNewLabel_5 = new JLabel(currentQuestion.getAnswer2());
		lblNewLabel_5.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_5.setFont(new Font("Corbel", Font.BOLD, 15));
		lblNewLabel_5.setBounds(178, 88, 78, 20);
		panel.add(lblNewLabel_5);

		JLabel lblNewLabel_6 = new JLabel(currentQuestion.getAnswer3());
		lblNewLabel_6.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_6.setFont(new Font("Corbel", Font.BOLD, 15));
		lblNewLabel_6.setBounds(335, 88, 94, 20);
		panel.add(lblNewLabel_6);

		JLabel lblNewLabel_7 = new JLabel(currentQuestion.getAnswer4());
		lblNewLabel_7.setFont(new Font("Corbel", Font.BOLD, 15));
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (position < questionList.size()) {
					...
					extremeImg.setIcon(new ImageIcon(QuestionnaireView.class.getResource("C:\\Users\\User\\Desktop\\StudentFeedback\\src\\img\\SmilingG.png")));
					agreeImg.setIcon(new ImageIcon(QuestionnaireView.class.getResource("C:\\Users\\User\\Desktop\\StudentFeedback\\src\\img\\SmileG.png")));
					maybeImg.setIcon(new ImageIcon(QuestionnaireView.class.getResource("C:\\Users\\User\\Desktop\\StudentFeedback\\src\\img\\NeutralG.png")));
					noImg.setIcon(new ImageIcon(QuestionnaireView.class.getResource("C:\\Users\\User\\Desktop\\StudentFeedback\\src\\img\\DisagreeG.png")));
